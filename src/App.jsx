    ...
    <main>
      <nav className="nav shell">
        <a className="brand" href="#top" aria-label="Employee Verifier home">
          ...
          <span className="brand-copy"><span>EMPLOYEE<span>VERIFIER</span></span><small>RECORD SEARCH • LEGAL SERVICES</small></span>
        </a>
      ...
      <footer className="footer shell">
        <div className="footer-brand"><a className="brand" href="#top"><span className="brand-mark"><ShieldCheck size={20} /><i></i></span><span className="brand-copy"><span>EMPLOYEE<span>VERIFIER</span></span><small>RECORD SEARCH • LEGAL SERVICES</small></span></a><p>Identity and employment verification,<br />public records, and legal support in one place.</p></div>
